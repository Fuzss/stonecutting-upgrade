...
public class CustomStonecutterScreen extends AbstractWidgetsContainerScreen<StonecutterMenu> {
    ...
    private void refillSlotFromCarried(Slot inputSlot, boolean moveAllItems) {
        int buttonNum = moveAllItems ? AbstractContainerMenu.CONTAINER_CLICK_PRIMARY :
                AbstractContainerMenu.CONTAINER_CLICK_SECONDARY;
        this.slotClicked(inputSlot, inputSlot.index, buttonNum, ContainerInput.PICKUP);
    }
    ...
    private void refillSlotFromInventory(Slot inventorySlot, Slot inputSlot, boolean moveAllItems) {
        this.slotClicked(inventorySlot,
                inventorySlot.index,
                AbstractContainerMenu.CONTAINER_CLICK_PRIMARY,
